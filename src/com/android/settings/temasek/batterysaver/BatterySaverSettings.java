...
package com.android.settings.temasek.batterysaver;
...
import com.android.settings.temasek.TimeRangePreference;
...
public class BatterySaverSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSmartBrightness = (CheckBoxPreference) prefSet.findPreference(PREF_KEY_BATTERY_SAVER_MODE_BRIGHTNESS);
        mSmartBrightness.setChecked(Settings.Global.getInt(resolver,
        ...
        mInitialBrightness.setValue(Settings.Global.getInt(resolver,
                     Settings.Global.BATTERY_SAVER_BRIGHTNESS_LEVEL, 50));
        mInitialBrightness.setOnPreferenceChangeListener(this);

        try {
            if (Settings.System.getInt(resolver,
                    Settings.System.SCREEN_BRIGHTNESS_MODE) == Settings.System.SCREEN_BRIGHTNESS_MODE_AUTOMATIC) {
                mSmartBrightness.setEnabled(false);
                mSmartBrightness.setSummary(R.string.status_bar_toggle_info);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        } else if (preference == mSmartBrightness) {
            boolean value = (Boolean) newValue;
            Settings.Global.putInt(resolver,
